    ...
    <div v-for="(note, index) in notes" class="task-note" v-show="showNote">
        <div class="columns">
            <div class="column is-1">
                <button class="button is-outlined is-danger is-small is-pulled-left" @click="removeNote(index, note.id)">
                <span class="icon"><i class="fa fa-trash"></i></span>
                </button>
            </div>
            <div class="column">
                <p><strong>{{ note.createdBy }}</strong> - <small>{{ note.diffForHumans }}</small></p>
